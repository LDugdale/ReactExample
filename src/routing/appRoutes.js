...
export const homeRoutes = (handleOpenAddPlant) => {
    return (
        <Switch>
            <Redirect exact from={routes.HOME} to={routes.PLANTS}/>
            <Route exact path={routes.SOCIAL} component={Plants} />x 
            <Route path={routes.PLANTS} render={(props) => <Plants {...props} onOpenAddPlant={handleOpenAddPlant} />} />
